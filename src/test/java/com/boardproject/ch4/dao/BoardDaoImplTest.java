...
public class BoardDaoImplTest {
    ...
    public void searchSelectPageTest() throws Exception{
        ...
        for(int i =1; i<=20; i++){
            BoardDto boardDto = new BoardDto("title"+i, "no content", "rlarltj");
    ...
    public void countTest() throws Exception {
        ...
        BoardDto boardDto = new BoardDto("no title", "no content", "kiseo");
    ...
    public void deleteAllTest() throws Exception {
        ...
        boardDto = new BoardDto("no title", "no content", "kiseo");
        assertTrue(boardDao.insert(boardDto)==1);
        assertTrue(boardDao.insert(boardDto)==1);
    ...
    public void selectPageTest() throws Exception {
        ...
        for (int i = 1; i <= 10; i++) {
            BoardDto boardDto = new BoardDto(""+i, "no content"+i, "kiseo");
            boardDao.insert(boardDto);
        }
